...
class DaskAttrEquivalenceBlocker(Blocker):
    ...
    def block_tables(self, ltable, rtable, l_block_attr, r_block_attr,
        ...
        Examples:
            ...
            >>> ab = em.DaskAttrEquivalenceBlocker()
        ...
        if n_procs <= 1:
            ...
            c_splits = c_splits.compute(scheduler="processes", n_jobs=n_procs)
    ...
    def block_candset(self, candset, l_block_attr, r_block_attr,
        ...
        """
        print("WARNING THIS COMMAND IS EXPERIMENTAL AND NOT TESTED. USE AT YOUR OWN "
              "RISK.")
